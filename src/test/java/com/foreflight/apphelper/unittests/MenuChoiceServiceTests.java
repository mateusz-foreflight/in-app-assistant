...
//        // Given
//        MockProfile1 mockProfile = new MockProfile1(menuChoiceRepository, resourceService);
//        MenuChoiceCreateDTO dto = new MenuChoiceDTO("new", null, Collections.emptyList());
//
//        // When
...
//        // Given
//        MockProfile1 mockProfile = new MockProfile1(menuChoiceRepository, resourceService);
//        MenuChoiceCreateDTO dto = new MenuChoiceDTO("new", "choice2", Collections.singletonList("resource1"));
//
//        // When
//        MenuChoice actual = menuChoiceService.addChoice(dto);
//        actual.setId(5L);
...
//        // Given
//        MockProfile1 mockProfile = new MockProfile1(menuChoiceRepository, resourceService);
//        MenuChoiceCreateDTO dto = new MenuChoiceDTO(null, null, Collections.emptyList());
//
//        // When, Then
//        assertThatExceptionOfType(IllegalStateException.class)
...
//        // Given
//        MockProfile1 mockProfile = new MockProfile1(menuChoiceRepository, resourceService);
//        MenuChoiceCreateDTO dto = new MenuChoiceDTO("new", "doesNotExist", Collections.emptyList());
//
//        // When, Then
//        assertThatExceptionOfType(IllegalStateException.class)
//                .isThrownBy(() -> menuChoiceService.addChoice(dto))
...
//        // Given
//        MockProfile1 mockProfile = new MockProfile1(menuChoiceRepository, resourceService);
//        MenuChoiceCreateDTO dto = new MenuChoiceDTO("new", null, Collections.singletonList("doesNotExist"));
//
//        // When, Then
//        assertThatExceptionOfType(IllegalStateException.class)
//                .isThrownBy(() -> menuChoiceService.addChoice(dto))
...
//        // Given
//        MockProfile1 mockProfile = new MockProfile1(menuChoiceRepository, resourceService);
//        MenuChoiceCreateDTO dto = new MenuChoiceDTO("newChoice3", "choice2", Collections.singletonList("resource1"));
//
//        // When
